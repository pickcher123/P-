...
export default function OpenPackPage() {
    ...
    return (
        <div className="flex flex-col items-center h-screen p-2 pt-2 relative overflow-hidden select-none touch-none justify-start md:justify-center bg-[url('/draw_background.png')] bg-cover bg-center bg-no-repeat">
